...
CREATE TABLE prescription (
    ...
    PRIMARY KEY (
        "PrescriptionNumber" AUTOINCREMENT
    ),
    FOREIGN KEY (
        BookingNo
    )
...
INSERT INTO Users (
                  ...
                  VALUES (
                      '1929282829',
                      'testPatient',
                      '611c16ea1a3e297f24b2b71133381dab48cefcde703ba3760a25a06188f02c07',
...
CREATE TABLE "Visit" (
	"BookingNo"	INTEGER,
	"NHSNo"	INTEGER NOT NULL CHECK("NHSNo" BETWEEN 1000000000 AND 9999999999),
	"StaffID"	VARCHAR(10) NOT NULL,
	"Timeslot"	DATETIME NOT NULL,
	"PatientInfo"	BLOB,
